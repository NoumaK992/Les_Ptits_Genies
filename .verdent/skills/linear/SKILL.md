...
metadata:
  version: 1.0.0
  short-description: Manage Linear issues in Verdent
---
...
2. Add the Linear MCP server with URL: `https://mcp.linear.app/mcp`
3. Follow the OAuth authentication flow when prompted

After successful setup, the MCP tools will be available for use.
